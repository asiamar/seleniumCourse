...
public class filter_in_sellenioum118 {
	...
	public static void main(String[] args) {
		...
		//przypadek2
		//chcemy zwróciæ cene fasoli, trzeba zrobiæ liste warzyw z kolumny pierwszej i wyfiltrowac po s³owie Rice, a nastepnie nowa metoda dostac sie do ceny
		
		List <String> price;  //musimy zddeklarowac powyzej, poniewaz while (price-by³o wenatrz)
		do
		{
			List <WebElement> rows = driver.findElements(By.xpath("//tr/td[1]")); //musimy powtórzyc, bo po kliknieciu lista sie zmienia
		...
		if(price.size()<1)
{
	...
	private static String getVeggiePrice (WebElement s) { //trzeba utworzyc metode, której uzywamy powyzej, w metodzie przekazujemy argumenty
