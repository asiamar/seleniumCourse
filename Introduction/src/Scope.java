...
public class Scope {
	...
	for (int i=1; i<collumnsection.findElements(By.tagName("a")).size();i++) 
	{
		...
		collumnsection.findElements(By.tagName("a")).get(i).sendKeys(clickonlinkTab); //nie dzia³a, poniewa¿ otwiera nam siê link i nie mo¿emy znale kolejnego na nowej stronie; 
	Thread.sleep(5000L);
	}
