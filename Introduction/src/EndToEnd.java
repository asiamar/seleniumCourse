...
public class EndToEnd {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if(!driver.findElement(By.id("Div1")).getAttribute("style").contains("1")) //tutaj oczekujemy, ze bedzie przeciwienstwo zawierania jedynki, czyli atrybut nie zawiera 1 - jesli warunek jest spe³niony i atrybut nie zawiera to wpadasz w pierwszy nawias
		{
			Assert.assertTrue(true); //zachowujesz sie tak jakby by³o ok - czyli mamy asercje która oczekuje true i ma true 
		}
		else
		{
			Assert.assertFalse(true); // a jesli warunek jest niespe³niony to wywal b³edem tak jak to robi asercja false, która w srodku ma true
		}
